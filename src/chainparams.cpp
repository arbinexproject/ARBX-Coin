...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000c56d77e769c76289cb172b6263d10ae99e55429762d6eb690058d1143e8"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553898353, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0437023fdb828a09818edb7aa0e898725ba593bd479e4b9f455b936e8f7e54a9f1e0dd1dd556ccbac595096afc7bab7d466dbc543be64dea5d5284b36b7e925e6b");
        nDefaultPort = 16801;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Arbinex starting difficulty is 1 / 2^12
        ...
        const char* pszTimestamp = "Arbinex coin (ARBX) was born.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04bbc4269ce36c7dc415d169eb1ddd65a5a224d1cf31fb0e64c3086bbfbe545165cef9e1bd745231e8fa1d8f23ccc3521a371a1b580c9597cac21a24e01a05f461") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1553898353;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1910283;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c56d77e769c76289cb172b6263d10ae99e55429762d6eb690058d1143e8"));
        assert(genesis.hashMerkleRoot == uint256("0x7be7af9d79ce57ef5b4c30bce4ebe24daa014e50e220453bf1a1ff4a9b740315"));

        vSeeds.push_back(CDNSSeedData("165.22.138.110", "165.22.138.110"));
        vSeeds.push_back(CDNSSeedData("165.22.138.110", "165.22.138.110"));
        vSeeds.push_back(CDNSSeedData("165.22.138.110", "165.22.138.110"));
	...
	strSporkKey = "04f8adfc2bd97f181a1a940948c3a7060aa492af8227d7e959bfb4a66a0e96f32387bcaaf2bcec0196b5af0b694adfa9f05c3a0d299f35057d7229b29cc7beb0d2";
        strObfuscationPoolDummyAddress = "QTszGTjG6GMDMgxYQXeYhbvhhAXazCYPDb";
        nStartMasternodePayments = 1553898353;
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04gb89975265af1d4c6295d3587eb4a0e4b758bde5741ef2ab8f92b02e7ed1c85547c9b7a3f145a77aa2abb91db5c13295828e77d823ea6d9b4bb89912425e1efe");
        nDefaultPort = 16701;
        nEnforceBlockUpgradeMajority = 51;
        nRejectBlockOutdatedMajority = 75;
        nToCheckBlockUpgradeMajority = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Arbinex: 1 day
        nTargetSpacing = 1 * 90;  // Arbinex: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet arbinex addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet arbinex script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet arbinex BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet arbinex BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet arbinex BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Arbinex: 1 day
        nTargetSpacing = 1 * 60;        // Arbinex: 1 minutes
