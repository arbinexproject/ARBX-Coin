...
/** Utility functions used by the Arbinex Qt UI.
 */
namespace GUIUtil
{
...
// Render Arbinex addresses in monospace font
...
// Parse "arbinex:" URI into recipient object, return true on successful parsing
