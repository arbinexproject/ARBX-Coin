                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Arbinex from zARBX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zARBX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zARBX));
