...
bool parseCommandLine(std::vector<std::string>& args, const std::string& strCommand)
{
    ...
    foreach (char ch, strCommand) {
        ...
        case STATE_EATING_SPACES: // Handle runs of whitespace
            switch (ch) {
            case '"':
                state = STATE_DOUBLEARBXED;
                break;
            case '\'':
                state = STATE_SINGLEARBXED;
                break;
            case '\\':
            ...
            break;
        case STATE_SINGLEARBXED: // Single-quoted string
            switch (ch) {
            case '\'':
                state = STATE_ARGUMENT;
                break;
            ...
            break;
        case STATE_DOUBLEARBXED: // Double-quoted string
            switch (ch) {
            case '"':
                state = STATE_ARGUMENT;
                break;
            case '\\':
                state = STATE_ESCAPE_DOUBLEARBXED;
                break;
            default:
                curarg += ch;
            }
        ...
        case STATE_ESCAPE_OUTER: // '\' outside quotes
            ...
            state = STATE_ARGUMENT;
            break;
        case STATE_ESCAPE_DOUBLEARBXED:                  // '\' in double-quoted text
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Arbinex RPC console.") + "<br>" +
