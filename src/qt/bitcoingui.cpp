                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Arbinex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Arbinex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and arbinex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Arbinex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Arbinex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arbinex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Arbinex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Arbinex addresses"));
    ...
    openAction->setStatusTip(tr("Open a Arbinex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Arbinex Core help message to get a list with possible Arbinex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Arbinex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Arbinex network", "", count));
}
...
{
    QString strTitle = tr("Arbinex Core"); // default title
...
/** Creates context menu, its actions, and arbinexs up all the relevant signals for mouse events. */
