...
public:
    ...
    void setZArbinexControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzARBX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzARBX_clicked();
    void on_pushButtonZArbinexControl_clicked();
