...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Arbinex Core arbinex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  arbinex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded arbinex transaction") + "\n" +
                               "  arbinex-tx [options] -create [commands]   " + _("Create hex-encoded arbinex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded arbinex transaction
