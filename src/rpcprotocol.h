...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Arbinex is not connected
    ...
    RPC_WALLET_PASSARBINEXASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
