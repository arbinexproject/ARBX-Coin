...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Arbinex server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Arbinex features */
        {"arbinex", "masternode", &masternode, true, true, false},
        {"arbinex", "listmasternodes", &listmasternodes, true, true, false},
        {"arbinex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"arbinex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"arbinex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"arbinex", "masternodedebug", &masternodedebug, true, true, false},
        {"arbinex", "startmasternode", &startmasternode, true, true, false},
        {"arbinex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"arbinex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"arbinex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"arbinex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"arbinex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"arbinex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"arbinex", "mnbudget", &mnbudget, true, true, false},
        {"arbinex", "preparebudget", &preparebudget, true, true, false},
        {"arbinex", "submitbudget", &submitbudget, true, true, false},
        {"arbinex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"arbinex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"arbinex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"arbinex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"arbinex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"arbinex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"arbinex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"arbinex", "checkbudgets", &checkbudgets, true, true, false},
        {"arbinex", "mnsync", &mnsync, true, true, false},
        {"arbinex", "spork", &spork, true, true, false},
        {"arbinex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"arbinex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use arbinexd, or the -server option to arbinex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> arbinex-cli " + methodname + " " + args + "\n";
}
