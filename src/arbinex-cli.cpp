...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Arbinex Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  arbinex-cli [options] <command> [params]  " + _("Send command to Arbinex Core") + "\n" +
                        "  arbinex-cli [options] help                " + _("List commands") + "\n" +
                        "  arbinex-cli [options] help <command>      " + _("Get help for a command") + "\n";
