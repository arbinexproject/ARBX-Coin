Contributing to Arbinex Core
============================

The Arbinex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Arbinex Core project, and is not to be
confused with overall Arbinex Network Protocol consensus changes.

Whether a pull request is merged into Arbinex Core rests with the project merge
...
Patches that change Arbinex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Arbinex consensus, it must have been
...
The project leader is the release manager for each Arbinex Core release.
