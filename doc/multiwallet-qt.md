...
In order to support loading of multiple wallets in arbinex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is arbinex.cpp.
...
Changes to arbinex.cpp
----------------------
arbinex.cpp is the entry point into arbinex-qt, and as such, will require some minor modifications to provide hooks for
