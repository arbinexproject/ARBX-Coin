...
RESOURCES += src/qt/arbinex.qrc src/qt/arbinex_locale.qrc

TRANSLATIONS += src/qt/locale/arbinex_bg.ts \
                src/qt/locale/arbinex_de.ts \
                src/qt/locale/arbinex_en.ts \
                src/qt/locale/arbinex_es.ts \
                src/qt/locale/arbinex_fi.ts \
                src/qt/locale/arbinex_fr.ts \
                src/qt/locale/arbinex_it.ts \
                src/qt/locale/arbinex_ja.ts \
                src/qt/locale/arbinex_pl.ts \
                src/qt/locale/arbinex_pt.ts \
                src/qt/locale/arbinex_ru.ts \
                src/qt/locale/arbinex_sk.ts \
                src/qt/locale/arbinex_sv.ts \
                src/qt/locale/arbinex_vi.ts \
                src/qt/locale/arbinex_zh_CN.ts \
                src/qt/locale/arbinex_zh_TW.ts
